<!DOCTYPE html>
	...
	<title>Log In &lsaquo; Oasis Life Recovery Ministry &#8212; WordPress</title>
...
<link rel='stylesheet' id='login-css'  href='/wp-admin/css/login.min.css?ver=5.2' type='text/css' media='all' />
	...
	<body class="login login-action-login wp-core-ui  locale-en-nz">
		<div id="login">
	...
	<p class="submit">
		<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In" />
				<input type="hidden" name="redirect_to" value="https://www.olrm.org.nz/wp-admin/" />
	...
	d.select();
		...
		&larr; Back to Oasis Life Recovery Ministry	</a></p>
